        ...
        >
          <div className="relative">
            {testimonials.map((testimonial, index) => (
              <motion.div
                key={testimonial.id}
                className={`rounded-2xl bg-gray-50 p-8 md:p-10 shadow-lg ${
            ...
            <div className="absolute top-1/2 left-0 -translate-y-1/2 -translate-x-5 hidden md:block">
              <button 
                onClick={prev}
                className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center text-[hsl(var(--deepblue))] hover:text-[hsl(var(--skyblue))] transition-colors"
